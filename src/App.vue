  ...
  data() {
    return {
      ...
      trending: [
        ...
        { top: 'Music', title: 'We Won', bottom: '135K Tweets', id: 8 },
        { top: 'Pop', title: 'Blue Ivy', bottom: '40k tweets', id: 7 },
        {
          top: 'Trending in US',
          title: 'Denim Day',
          bottom: '40k tweets',
      ...
      friends: [
        { src: 'elon.jpg', name: 'Elon Musk', handle: '@teslaBoy', id: 1 },
        { src: 'monk.jpg', name: 'Adrian Monk', handle: '@detective:)', id: 2 },
        { src: 'kevin.jpg', name: 'Kevin Hart', handle: '@miniRock', id: 3 },
      ],
      following: [
        {
          src: 'elon.jpg',
      ...
      tweets: [{ content: 'It is so nice outside!', id: 1 }],
      tweet: { content: '' },
    };
  },
  methods: {
